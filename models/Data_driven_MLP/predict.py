...
with tf.device('/gpu:0'):
    ...
    pd.DataFrame(A_MLP).to_csv(f'./results_{DataName}/A_MLP.csv', index=False)
    pd.DataFrame(V_MLP).to_csv(f'./results_{DataName}/V_MLP.csv', index=False)
    pd.DataFrame(Y_MLP).to_csv(f'./results_{DataName}/Y_MLP.csv', index=False)
